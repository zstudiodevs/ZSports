...
export class ToolbarComponent {
	...
	protected asDropdownButton(
		button: Button | IconButton | DropdownButton
	): DropdownButton | null {
	...
	protected isButton(button: any): boolean {
		return (
			(button as Button).label !== undefined ||
			(button as Button).icon !== undefined
		);
	}
	...
	protected isIconButton(button: any): boolean {
		return (
			(button as IconButton).icon !== undefined && 'label' in button === false
		);
	}
